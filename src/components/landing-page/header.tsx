...
const Header = () => {
    ...
    return <header className='p-4 flex justify-center items-center'>
        ...
        <span className='font-semibold dark:text-white'>Utsav Notions.</span>
        </Link>
          ...
          <NavigationMenuList className='gap-6'>
              ...
              <NavigationMenuContent>
                <ul className='grid gap-3 p-6 md:w-[400px] ld:w-[500px] lg:grid-cols-[.75fr_1fr]'>
                  <li className='row-span-3'>
                    <span className='flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-5 no-underline outline-none focus:shadow-md'>
                      Welcome
                    </span>
                  </li>
                  <ListItem
            ...
            {/* <NavigationMenuItem>
                <NavigationMenuLink href='#' className={cn(navigationMenuTriggerStyle(), {
                  ...
                  'dark:test-white/40': path !== '#testimonials',
                  'font-normal': true,
                  'text-xl': true,
                })}>
                  Testimonial
